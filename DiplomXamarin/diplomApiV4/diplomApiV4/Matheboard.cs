...
namespace diplomApiV4
{
    public partial class Matheboard
    {
        ...
        public string MatheboardName { get; set; } = null!;
        ...
        public virtual ChipsetTypeMatheboard MatheboardChipset { get; set; } = null!;
        public virtual Manufacturer MatheboardManufacturer { get; set; } = null!;
        public virtual SocketType MatheboardSocket { get; set; } = null!;
        [JsonIgnore]
